...
data = sio.loadmat(r'C:\Users\JAH\Desktop\组\random walk\quantumQuasi2D\quantumQuasi2D.mat')
...
def update(i):
    ...
    ax1.set_title("quasi2D quantum random walk")
    ax1.set_xlabel('X')
    ax1.set_ylabel('Y')
    ax1.set_zlabel('p')
...
# plt.show()
anim.save(r'C:\\Users\\JAH\\Desktop\\组\\random walk\\quantumQuasi2D\\Quasi2D quantum probability distribution.gif')