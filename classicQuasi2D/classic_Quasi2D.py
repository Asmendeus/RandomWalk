...
data = sio.loadmat(r'C:\Users\JAH\Desktop\组\random walk\classicQuasi2D\classicQuasi2D.mat')
...
#     ax1.set_title("Quasi2D classic random walk")
#     ax1.set_xlabel('X')
#     ax1.set_ylabel('Y')
#     ax1.set_zlabel('p')
...
anim = FuncAnimation(fig, update, frames=np.arange(0, Nstep), interval=100, blit=False, repeat=False)
# plt.show()
anim.save(r'C:\\Users\\JAH\\Desktop\\组\\random walk\\classicQuasi2D\\Quasi2D classic single particle.gif')